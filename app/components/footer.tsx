      ...
      <Container>
        <div className="py-12">
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  <Link
                    href="https://linkedin.com/company/omnistrate"
                    className="text-gray-700 hover:text-gray-900 transition-colors text-[15px]"
                  >
                    LinkedIn
                  </Link>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Link
                    href="https://twitter.com/omnistrate"
                    className="text-gray-700 hover:text-gray-900 transition-colors text-[15px]"
                  >
                    Twitter
                  </Link>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Link
                    href="https://facebook.com/omnistrate"
                    className="text-gray-700 hover:text-gray-900 transition-colors text-[15px]"
                  >
                    Facebook
                  </Link>
          ...
          <div className="border-t border-gray-200 pt-6 mt-8">
            <p className="text-gray-400 text-sm">© 2025 Omnistrate.Inc All rights reserved.</p>
          </div>
        </div>
      </Container>
    </footer>
